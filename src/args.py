...
# change path here      -- the path should contain the 'STACK_GAN_Project' folder
PATH_STR = '/Users/anshikaraman/Downloads/submission'
...
def add_train_args(parser):
    ...
    parser.add_argument("--STAGE1_G_path",
                        type=str,
                        default=f"{PATH_STR}/STACK_GAN_Project/output/model_stage2/netG_epoch_350.pth",
    ...
    parser.add_argument("--datapath",
                        type=str,
                        default=f"{PATH_STR}/STACK_GAN_Project/output",
                        help="datapath dir")
    parser.add_argument("--image_save_dir",
                        type=str,
                        default=f"{PATH_STR}/STACK_GAN_Project/output/results_stage2_40",
                        help="Image save dir")
    parser.add_argument("--model_dir",
                        type=str,
                        default=f"{PATH_STR}/STACK_GAN_Project/output/model_stage1/",
                        help="Model save dir")
    parser.add_argument("--log_dir",
                        type=str,
                        default=f"{PATH_STR}/STACK_GAN_Project/output/log/",
...
def add_data_args(parser):
    ...
    parser.add_argument("--images_dir",
                        type=str,
                        default=f"{PATH_STR}/STACK_GAN_Project/input/data/CUB_200_2011/images/",
...
def add_birds_file_args(parser):
    ...
    parser.add_argument("--cnn_annotations_emb_train",
                        type=str,
                        default=f"{PATH_STR}/STACK_GAN_Project/input/data/birds/train/char-CNN-RNN-embeddings.pickle",
                        help="char-CNN-RNN-embeddings pickle file for train")
    parser.add_argument("--cnn_annotations_emb_test",
                        type=str,
                        default=f"{PATH_STR}/STACK_GAN_Project/input/data/birds/test/char-CNN-RNN-embeddings.pickle",
                        help="char-CNN-RNN-embeddings pickle file for test")
    parser.add_argument("--train_filenames",
                        type=str,
                        default=f"{PATH_STR}/STACK_GAN_Project/input/data/birds/train/filenames.pickle",
                        help="Pickle file path: filenames for train set")
    parser.add_argument("--test_filenames",
                        type=str,
                        default=f"{PATH_STR}/STACK_GAN_Project/input/data/birds/test/filenames.pickle",
...
def add_cub_file_args(parser):
    ...
    parser.add_argument("--images_id_file",
                        type=str,
                        default=f"{PATH_STR}/STACK_GAN_Project/input/data/CUB_200_2011/images.txt",
                        help="Text file path: mapping image id to image path")  # <image_id> <image_name>
    parser.add_argument("--train_test_split_file",
                        type=str,
                        default=f"{PATH_STR}/STACK_GAN_Project/input/data/CUB_200_2011/train_test_split.txt",
                        help="Text file path: mapping image id to train/test split")  # <image_id> <is_training_image>
    parser.add_argument("--bounding_boxes",
                        type=str,
                        default=f"{PATH_STR}/STACK_GAN_Project/input/data/CUB_200_2011/bounding_boxes.txt",
